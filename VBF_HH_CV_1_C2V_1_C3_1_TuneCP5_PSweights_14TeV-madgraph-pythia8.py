...
# with command line options: Configuration/GenProduction/python/TSG-Run3Winter20wmLHEGS-00010-fragment.py --python_filename=VBF_HH_CV_1_C2V_1_C3_1_TuneCP5_PSweights_14TeV-madgraph-pythia8.py --fileout file:VBF_HH_CV_1_C2V_1_C3_1_TuneCP5_PSweights_14TeV-madgraph-pythia8_GENSIMDIGIRAW.root --mc --eventcontent PREMIXRAW --datatier GEN-SIM-RAW --conditions 110X_mcRun3_2021_realistic_v6 --beamspot Run3RoundOptics25ns13TeVLowSigmaZ --step LHE,GEN,SIM,DIGI,DATAMIX,L1,DIGI2RAW,HLT:GRun --geometry DB:Extended --pileup_input dbs:/Neutrino_E-10_gun/RunIISummer17PrePremix-PURun3Winter20_110X_mcRun3_2021_realistic_v6-v1/PREMIX --procModifiers premix_stage2 --nThreads 4 --datamix PreMix --era Run3 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/TSG-Run3Winter20wmLHEGS-00010-fragment.py nevts:1'),
...
process.PREMIXRAWoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:VBF_HH_CV_1_C2V_1_C3_1_TuneCP5_PSweights_14TeV-madgraph-pythia8_GENSIMDIGIRAW.root'),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('/cvmfs/cms.cern.ch/phys_generator/gridpacks/slc6_amd64_gcc630/14TeV/madgraph/V5_2.6.0/VBF_HH_CV_1_C2V_1_C3_1_14TeV-madgraph/VBF_HH_CV_1_C2V_1_C3_1_14TeV-madgraph_slc6_amd64_gcc630_CMSSW_9_3_16_tarball.tar.xz'),
