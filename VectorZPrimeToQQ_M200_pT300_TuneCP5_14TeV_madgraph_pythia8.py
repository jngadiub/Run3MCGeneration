...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/TSG-Run3Winter20wmLHEGS-00015-fragment.py nevts:1'),
...
process.PREMIXRAWoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:VectorZPrimeToQQ_M200_pT300_TuneCP5_14TeV_madgraph_pythia8_GENSIMDIGIRAW.root'),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('/cvmfs/cms.cern.ch/phys_generator/gridpacks/2017/14TeV/madgraph/V5_2.6.1/VectorZPrimeToQQ/v3/ZPrimeToQQ_DMsimp_HT600_M200/ZPrimeToQQ_DMsimp_HT600_M200_slc6_amd64_gcc630_CMSSW_9_3_16_tarball.tar.xz'),
