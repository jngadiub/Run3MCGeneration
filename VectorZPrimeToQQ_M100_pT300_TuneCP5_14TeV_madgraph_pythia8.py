...
# with command line options: Configuration/GenProduction/python/TSG-Run3Winter20wmLHEGS-00014-fragment.py --python_filename=VectorZPrimeToQQ_M100_pT300_TuneCP5_14TeV_madgraph_pythia8.py --fileout file:VectorZPrimeToQQ_M100_pT300_TuneCP5_14TeV_madgraph_pythia8_GENSIMDIGIRAW.root --mc --eventcontent PREMIXRAW --datatier GEN-SIM-RAW --conditions 110X_mcRun3_2021_realistic_v6 --beamspot Run3RoundOptics25ns13TeVLowSigmaZ --step LHE,GEN,SIM,DIGI,DATAMIX,L1,DIGI2RAW,HLT:GRun --geometry DB:Extended --pileup_input dbs:/Neutrino_E-10_gun/RunIISummer17PrePremix-PURun3Winter20_110X_mcRun3_2021_realistic_v6-v1/PREMIX --procModifiers premix_stage2 --nThreads 4 --datamix PreMix --era Run3 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/TSG-Run3Winter20wmLHEGS-00014-fragment.py nevts:1'),
...
process.PREMIXRAWoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:VectorZPrimeToQQ_M100_pT300_TuneCP5_14TeV_madgraph_pythia8_GENSIMDIGIRAW.root'),
...
process.genfilter = cms.EDFilter("GenParticleSelector",
    cut = cms.string('(pdgId==55) && pt>300. && isLastCopy()'),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('/cvmfs/cms.cern.ch/phys_generator/gridpacks/2017/14TeV/madgraph/V5_2.6.1/VectorZPrimeToQQ/v3/ZPrimeToQQ_DMsimp_HT600_M100/ZPrimeToQQ_DMsimp_HT600_M100_slc6_amd64_gcc630_CMSSW_9_3_16_tarball.tar.xz'),
