...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/TSG-Run3Winter20wmLHEGS-00004-fragment.py nevts:1'),
...
process.PREMIXRAWoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:VBF_HToInvisible_M125_TuneCUETP8M1_14TeV_powheg_pythia8_GENSIMDIGIRAW.root'),
